...
public interface ArnoldCveroListener extends ParseTreeListener {
	 ...
	 * labeled alternative in {@link ArnoldCveroParser#arnoldCom}.
	 * @param ctx the parse tree
	 */
	void enterArnoldIf(ArnoldCveroParser.ArnoldIfContext ctx);
	/**
	 * Exit a parse tree produced by the {@code arnoldIf}
	 * labeled alternative in {@link ArnoldCveroParser#arnoldCom}.
	 * @param ctx the parse tree
	 */
	void exitArnoldIf(ArnoldCveroParser.ArnoldIfContext ctx);
	/**
	 * Enter a parse tree produced by the {@code arnoldDeclare}
	 * labeled alternative in {@link ArnoldCveroParser#arnoldCom}.
	 * @param ctx the parse tree
	 */
	void enterArnoldDeclare(ArnoldCveroParser.ArnoldDeclareContext ctx);
	/**
	 * Exit a parse tree produced by the {@code arnoldDeclare}
	 * labeled alternative in {@link ArnoldCveroParser#arnoldCom}.
	 * @param ctx the parse tree
	 */
	void exitArnoldDeclare(ArnoldCveroParser.ArnoldDeclareContext ctx);
	/**
	 * Enter a parse tree produced by the {@code arnoldWhile}
	 * labeled alternative in {@link ArnoldCveroParser#arnoldCom}.
	 * @param ctx the parse tree
	 */
	void enterArnoldWhile(ArnoldCveroParser.ArnoldWhileContext ctx);
	/**
	 * Exit a parse tree produced by the {@code arnoldWhile}
	 * labeled alternative in {@link ArnoldCveroParser#arnoldCom}.
	 * @param ctx the parse tree
	 */
	void exitArnoldWhile(ArnoldCveroParser.ArnoldWhileContext ctx);
	/**
	 * Enter a parse tree produced by the {@code arnoldOut}
	 * labeled alternative in {@link ArnoldCveroParser#arnoldCom}.
	 * @param ctx the parse tree
	 */
	void enterArnoldOut(ArnoldCveroParser.ArnoldOutContext ctx);
	/**
	 * Exit a parse tree produced by the {@code arnoldOut}
	 * labeled alternative in {@link ArnoldCveroParser#arnoldCom}.
	 * @param ctx the parse tree
	 */
	void exitArnoldOut(ArnoldCveroParser.ArnoldOutContext ctx);
	/**
	 * Enter a parse tree produced by the {@code arnoldAssign}
	 * labeled alternative in {@link ArnoldCveroParser#arnoldCom}.
	 * @param ctx the parse tree
	 */
	void enterArnoldAssign(ArnoldCveroParser.ArnoldAssignContext ctx);
	/**
	 * Exit a parse tree produced by the {@code arnoldAssign}
	 * labeled alternative in {@link ArnoldCveroParser#arnoldCom}.
	 * @param ctx the parse tree
	 */
	void exitArnoldAssign(ArnoldCveroParser.ArnoldAssignContext ctx);
	/**
