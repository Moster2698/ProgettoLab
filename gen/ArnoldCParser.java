...
public class ArnoldCParser extends Parser {
	...
	@SuppressWarnings("CheckReturnValue")
	public static class ArnoldIDContext extends ExpressionContext {
		public TerminalNode ID() { return getToken(ArnoldCParser.ID, 0); }
		public ArnoldIDContext(ExpressionContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof ArnoldCListener ) ((ArnoldCListener)listener).enterArnoldID(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof ArnoldCListener ) ((ArnoldCListener)listener).exitArnoldID(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ArnoldCVisitor ) return ((ArnoldCVisitor<? extends T>)visitor).visitArnoldID(this);
			else return visitor.visitChildren(this);
		}
	}
	@SuppressWarnings("CheckReturnValue")
	...
	public final ExpressionContext expression() throws RecognitionException {
		...
		try {
			...
			case 1:
				_localctx = new ArnoldIDContext(_localctx);
				enterOuterAlt(_localctx, 1);
				{
				setState(64);
				match(ID);
