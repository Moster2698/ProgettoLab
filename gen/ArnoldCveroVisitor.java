...
public interface ArnoldCveroVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitArnoldIf(ArnoldCveroParser.ArnoldIfContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitArnoldDeclare(ArnoldCveroParser.ArnoldDeclareContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitArnoldWhile(ArnoldCveroParser.ArnoldWhileContext ctx);
	/**
	 * Visit a parse tree produced by the {@code arnoldOut}
	 * labeled alternative in {@link ArnoldCveroParser#arnoldCom}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitArnoldOut(ArnoldCveroParser.ArnoldOutContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitArnoldAssign(ArnoldCveroParser.ArnoldAssignContext ctx);
	/**
